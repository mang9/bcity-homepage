...
${tbody([
                  ...
                  ['30', '춘천에 435MW 하이퍼스케일 데이터센터', '전자신문', '2026.02.14', state('on'), rowActs('press')],
...
pages['partner-form.html'] = shell({
  ...
  body: formCard({
    ...
    fields: [
      ...
      /* ⚠ 카드 그룹 머리의 영문(ANCHOR PARTNER 등)은 **그룹** 이름이지 회사 영문 상호가 아니다.
         ⚠ 이 칸은 지금 어디에도 쓰이지 않는다 — 영문 페이지가 없다. 2026-09-03 에 뺄지 물었고
           **개발이 기존 기능정의대로 진행 중이라 그대로 두기로 했다.**
         DEV: 영문 사이트 범위 결정 — 영문이 필요한 것은 상호뿐이 아니다(카드 설명 · 그룹 설명 ·
           공지 · 언론 제목과 본문 · 페이지 카피 전부). 관리자 21화면에서 영문 필드는 이 하나뿐이고
           콘텐츠 데이터에는 언어 축이 없다. 정할 것은 '상호를 어디 두나' 가 아니라 '콘텐츠 필드
           전체에 언어를 어떻게 붙이나' 다. 갈래와 판단 근거는 HANDOFF.md §9 의 별항에 적어 두었다. */
